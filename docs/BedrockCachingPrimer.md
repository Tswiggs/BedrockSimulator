...
> Authors Note: The figures presented here are grounded in historical averages and estimated future implementations.  They highlight potential applications of the various cost saving mechanisms and are not a guarantee of how much these hypothetical features would cost to operate in the real world. 
